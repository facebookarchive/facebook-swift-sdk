...
set -o pipefail
xcodebuild test -workspace $XCODE_WORKSPACE -sdk iphonesimulator -scheme FacebookCore -configuration Debug -destination "platform=iOS Simulator,name=iPhone 8 Plus" | xcpretty -c
