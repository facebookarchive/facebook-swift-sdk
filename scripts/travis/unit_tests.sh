...
set -o pipefail
xcodebuild test -workspace "$XCODE_WORKSPACE" -sdk iphonesimulator -scheme FacebookCore -configuration Debug -destination "platform=iOS Simulator,OS=13.0,name=iPhone Xs" | xcpretty -c
