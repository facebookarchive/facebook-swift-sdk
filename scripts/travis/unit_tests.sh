...
set -o pipefail
xcodebuild test -workspace "$XCODE_WORKSPACE" -sdk iphonesimulator -scheme FacebookCore -configuration Debug -destination "platform=iOS Simulator,OS=11.0.1,name=iPhone 8 Plus" | xcpretty -c
