 ...
 */
 ...
 /* if set, a web-based URL is required; asset, image, and imageURL.isFileURL not allowed */protocol FBSDKSharingValidation: class {
    /**
     ...
     */
    func validate(with bridgeOptions: FBSDKShareBridgeOptions) throws
}